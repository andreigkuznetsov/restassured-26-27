...
public class TestData {
    ...
    public String password = faker.internet().password(8, 15, true, true);
    public String isbn = faker.options().option("9781449325862", "9781449331818", "9781449337711", "9781449365035",
